<template>
    <div class="header-section header-white" :class="{'is-sticky': isSticky}">
            ...
            <div class="container position-relative">
                <div class="row justify-content-between align-items-center" >
                    ...
                    <div class="col-auto d-flex" >
                        <div class="menu-column-area d-none d-xl-block d-lg-block position-static">
                            <nav class="site-main-menu">
                                <ul>
                                    ...
                                    <li>
                                        <n-link class="headers" style="text-decoration: none" to="#Contact">Contáctanos</n-link>
                                        <div class="linea"></div>
                                    </li>
                                    <li>
                        ...
                        <div class="header-mobile-menu-toggle d-lg-none d-xl-none d-md-block ml-sm-2 my-7">
