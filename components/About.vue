<template>
    <v-container id="About" fluid>
        <v-row align="center" justify="center" class="my-15">
            <v-col ccols="12" md="10" lg="9" sm="12">
                <v-row align="center" justify="center">
                    <v-col  cols="12" md="7" lg="7" sm="12">
                        <h1 class="my-6 mx-2" style="font-size: 30px">QUIÉNES SOMOS</h1>
                        <p class="mx-2">Somos una agencia de turismo, que tiene su zona de operación en la zona rural del Municipio de Villavieja buscando ofrecer sus productos con un alto contenido de las experiencias de la localidad y con la observación de las normas ambientales que gobiernan las zonas turísticas para que los destinos en que acompañamos su viaje para evitar un desgaste injusto y que las próximas generaciones puedan disfrutar del paisaje y la foto que usted se está tomando hoy.</p>
                    </v-col>
